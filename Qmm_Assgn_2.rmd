...
$P_i$ = means the number of units produced on each plant, where $i$= 1 (Plant 1), 2 (Plant 2), and 3 (Plant 3).

L, M, and S = means the product's size, where L = large, M = medium, and S = small.

##The decision variables are as follows

$P_iL$ = number of large items produced on plant $i$, where $i$= 1 (Plant 1), 2 (Plant 2), and 3 (Plant 3).

$P_iM$ = number of medium items produced on plant $i$, where $i$= 1 (Plant 1), 2 (Plant 2), and 3 (Plant 3).

$P_iS$ = number of small items produced on plant $i$, where $i$= 1 (Plant 1), 2 (Plant 2), and 3 (Plant 3).
...
$P_iS$ = number of small items produced on on plant $i$, where $i$= 1 (Plant 1), 2 (Plant 2), and 3 (Plant 3).

##Maximize Profit

$Z= 420 \ (P_1L + P_2L + P_3L) + 360 \ (P_1M + P_2M + P_3M) + 300 \ (P_1S + P_2S + P_3S)$
...
Plant 1 = $P_1L + P_1M + P_1S \ 750$

Plant 2 = $P_2L + P_2M + P_2S \ 900$

Plant 3 = $P_3L + P_3M + P_3S \ 450$

##Storage capacity per unit by plant each day:

Plant 1 = $20 P_1L + 15 P_1M + 12 P_1S \ 13000$

Plant 2 = $20 P_2L + 15 P_2M + 12 P_2S \ 12000$

Plant 3 = $20 P_3L + 15 P_3M + 12 P_3S \ 5000$

##Sales forecast per day:

$L = P_1L + P_2L + P_3L \ 900$

$M = P_1M + P_2M + P_3M \ 1200$

$S = P_1S + P_2S + P_3S \ 750$

##The plants should use the same percentage of their excess capacity to produce the new product.

$\dfrac {P_1L + P_1M + P_1S} {750}$ = $\dfrac {P_2L + P_2M + P_2S} {900}$ = $\dfrac {P_3L + P_3M + P_3S} {450}$
